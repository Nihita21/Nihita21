...
I build things that make data **speak clearly**: dashboards, models, tools, APIs.
My ideal project sits at the intersection of **insight and impact.**

- 🔭 Building: Data Science projects on real-world datasets
- 🤖 Exploring: AI/ML, LLM APIs, and intelligent web apps
...
- 🧠 LLM APIs and prompt engineering (Anthropic, OpenAI)
- 🐍 Python deep-dive — data structures, algorithms, ML pipelines
- ⚙️ C++ fundamentals — pointers, references, memory management
- 🌐 Full-Stack — Flask + Firebase + real-world deployment
...
I'm looking to work on Data Science, analytics, and AI/ML projects
